...
- **Фаза 0 — фундамент.**
  ...
  - Тестовый workspace `workspaces/__staging__` (или второй Firebase-проект) с копией данных.
