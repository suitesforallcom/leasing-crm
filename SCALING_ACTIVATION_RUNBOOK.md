...
When re-attempted: **Phase 1.3 strip frees ~207 KB; Phase 2.5 strip frees ~570 KB → combined 924→51 KB.** Requires dual-write + read-switch + Entry-37 cache fix + the `afed377` getDocs fallback (all shipped).
