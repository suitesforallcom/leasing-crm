...
When re-attempted on a stable connection: **Phase 1.3 strip frees ~207 KB; Phase 2.5 strip frees ~570 KB → combined 924→51 KB.** Both require dual-write + read-switch + Entry-37 fix + stable connection.
